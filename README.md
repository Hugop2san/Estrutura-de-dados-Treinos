...
O Exercicio foca na ideia de gerenciamento de parcelas . Hoje mergulhei nos conceitos de design usando Orientação a Objetos — mais especificamente na ideia de separar responsabilidades entre classes.
